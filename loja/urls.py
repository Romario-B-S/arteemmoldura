...
urlpatterns = [
    ...
    path('produto/<int:id_produto>/<int:id_tamanho>/', ver_produto, name="ver_produto"),
    ...
    path('pedido_selecionado/<int:id_produto>/', pedido_selecionado, name="pedido_selecionado"),
    ...
    path('finalizarpedido/', finalizar_pedido, name="finalizar_pedido"),
